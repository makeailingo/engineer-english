...
description: "Continuously observe performance indicators to catch changes and problems."
descriptionJa: "性能指標を継続的に観測し、変化や問題を捉えること。"
meaning: "Continuously monitor and check for changes"
meaningJa: "継続的に監視し、変化を確認する"
...
source:
  ...
  context: "実ユーザー監視と合成監視でWeb性能を継続観測し、問題を特定する文脈。"
---
