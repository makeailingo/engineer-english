...
description: "A mechanism for hiding complex implementation details behind a simple API."
descriptionJa: "複雑な実装詳細を、単純なAPIの背後に隠す仕組み。"
meaning: "Abstraction, a mechanism for hiding details"
meaningJa: "抽象化、詳細を隠す仕組み"
...
source:
  ...
  context: "複雑なシステムの技術的詳細を単純なAPIの背後に隠すプログラミングの文脈。"
---
