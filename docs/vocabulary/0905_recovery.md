...
description: "The process by which a service returns to a normal state after a failure."
descriptionJa: "障害後にサービスが正常な状態へ戻る過程。"
meaning: "recovery, recovery"
meaningJa: "復旧、回復"
...
source:
  ...
  context: "一時的な503応答で、サービスの復旧予定時間をRetry-Afterで示す文脈。"
---
