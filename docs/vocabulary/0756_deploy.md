...
description: "Deploy the application to the production environment and make it available."
descriptionJa: "アプリケーションを本番環境へ配置し利用可能にする。"
meaning: "place, make available"
meaningJa: "配置する、利用できる状態にする"
...
source:
  ...
  context: "Expressアプリケーションをクラウド上の本番Webサーバーへ配置する文脈。"
---
