...
description: "Dig into running code and values with developer tools."
descriptionJa: "開発者ツールで実行中のコードや値を詳しく調べること。"
meaning: "investigate in detail, inspect"
meaningJa: "詳しく調べる、検査する"
...
source:
  ...
  context: "ブラウザー開発者ツールで実行中のJavaScriptとエラーを詳しく調べる文脈。"
---
