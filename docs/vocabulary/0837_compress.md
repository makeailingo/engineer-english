...
description: "To reduce loading time by reducing the size of data to be transferred."
descriptionJa: "転送するデータを小さくして読み込み時間を短縮すること。"
meaning: "Compress, reduce the amount of data"
meaningJa: "圧縮する、データ量を小さくする"
...
source:
  ...
  context: "HTTP応答を圧縮して転送量を減らし、Webサイトの性能を高める文脈。"
---
