...
description: "Clarify ambiguous requirements or the intent of the code so that the other."
descriptionJa: "曖昧な要件やコードの意図を、相手が理解できるよう明確にすること。"
meaning: "make clear, make understandable"
meaningJa: "明確にする、分かりやすくする"
...
source:
  ...
  license: "CC BY 3.0"
  context: "読みにくいコードを、開発者に明確化してもらうコードレビューの文脈。"
---
