...
description: "Reduce the influencing factors and isolate the cause of the problem."
descriptionJa: "影響する要素を減らし、不具合の原因を切り分けること。"
meaning: "separate, identify"
meaningJa: "切り分ける、特定する"
...
source:
  ...
  context: "縮小したテストケースを作り、問題を最大限切り分ける文脈。"
---
