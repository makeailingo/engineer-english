...
description: "Articulate technical claims based on data and principles."
descriptionJa: "データや原則を根拠に、技術的な主張を明確に示す。"
meaning: "clearly show, demonstrate"
meaningJa: "明確に示す、実証する"
...
source:
  ...
  license: "CC BY 3.0"
  context: "複数の設計案が同等に妥当だと、データや確かな工学原則で示すコードレビューの文脈。"
---
