...
type: "word"
partOfSpeech: noun
pronunciation: "/ˌek.spekˈteɪ.ʃənz/"
description: "Conditions that are assumed to be met by the other party or system."
descriptionJa: "相手やシステムが満たすと想定する条件。"
meaning: "Expectations and assumed conditions"
meaningJa: "期待、想定される条件"
...
source:
  ...
  context: "HTTPリクエストを処理するためにサーバーが満たす条件を示す文脈。"
---
