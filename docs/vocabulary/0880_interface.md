...
description: "A contact point that a component exposes to external interaction."
descriptionJa: "構成要素が外部とのやり取りに公開する接点。"
meaning: "Interface, contact point between systems"
meaningJa: "インターフェース、システム間の接点"
...
source:
  ...
  context: "アプリケーションと外部のソフトウェアやハードウェアを結ぶ契約としてAPIを設計する文脈。"
---
